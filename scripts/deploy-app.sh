sed -i "s/TLS_CRT/$TLS_CRT/" kubernetes-ingress/tyler-dev-secret.yaml
sed -i "s/TLS_KEY/$TLS_KEY/" kubernetes-ingress/tyler-dev-secret.yaml
kubectl apply -f kubernetes-ingress/common/ns-and-sa.yaml
kubectl apply -f kubernetes-ingress/tyler-dev-secret.yaml
